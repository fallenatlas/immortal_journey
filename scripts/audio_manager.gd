...
@onready var music0 = preload("res://Audio/Music/nature_sounds.mp3")
@onready var music1 = preload("res://Audio/Music/Ambient1.mp3")
@onready var music2 = preload("res://Audio/Music/nature_sounds.mp3")
@onready var music3 = preload("res://Audio/Music/Ambient1.mp3")
@onready var music4 = preload("res://Audio/Music/cave_sounds.mp3")
@onready var music5 = preload("res://Audio/Music/Ambient1.mp3")
@onready var music6 = preload("res://Audio/Music/nature_sounds.mp3")
